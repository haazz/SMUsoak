...
public class AuthenticationControllerTest extends AbstractRestDocsTests {
                ...
                .andDo(
                        restDocs.document(
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("refreshToken").type(JsonFieldType.STRING).description("JWT refresh 토큰")
                                )
                        )
                );
    }
    ...
    void RefreshTokenTest() throws Exception {
        ...
        JwtTokenDto.RefreshTokenRequest refreshTokenRequest = new JwtTokenDto.RefreshTokenRequest();
        refreshTokenRequest.setRefreshToken("refreshToken");

        given(authenticationService.refreshToken(any(String.class)))
                .willReturn(JwtTokenDto.JwtAuthenticationResponse.builder()
                        .accessToken("accessToken")
                        .refreshToken("refreshToken")
                        .build());
